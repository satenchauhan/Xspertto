...
import QuoteFlagModal from './QuoteFlagModal';
    ...
    return (
        <View style={topStyles.topBox}>
            ...
            <View style={topStyles.buttonBox}>
                ...
                >
                    <Text style={topStyles.buttonLabel}>PREVIEW & SEND</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[topStyles.button,topStyles.convButton]}
                    onPress={() => setConvertModal(true)}
                >
                    <Text style={[topStyles.buttonLabel,{color:'#3851DD'}]}>CONVERT TO ...</Text>
                </TouchableOpacity>
            </View>
            <ConvertModal />
            <QuoteFlagModal />
