    ...
    return (
        <View>
            ...
            <View style={{ marginTop: 10 }}>
                <Text style={ItemStyles.optionTitle}>Door Style(select all that apply)</Text>
                <View style={[PanelStyle.iconsFlex, { paddingLeft: 2, paddingRight: 2 }]}>
                    <View style={PanelStyle.Box}>
                        <Image style={PanelStyle.ItemIcon} resizeMode='contain' source={require('../../assets/items-img/bi-fold-door.png')} />
                        <Text style={PanelStyle.IconTitle}>Bi-Fold Door</Text>
                    </View>
                    <View style={PanelStyle.Box}>
                        <Image style={PanelStyle.ItemIcon} resizeMode='contain' source={require('../../assets/items-img/flat-door.png')} />
                        <Text style={PanelStyle.IconTitle}>Flat Door</Text>
                    </View>
                    <View style={PanelStyle.Box}>
                        <Image style={PanelStyle.ItemIcon} resizeMode='contain' source={require('../../assets/items-img/french-door.png')} />
                        <Text style={PanelStyle.IconTitle}>French Door</Text>
                    </View>
                    <View style={PanelStyle.Box}>
                        <Image style={PanelStyle.ItemIcon} resizeMode='contain' source={require('../../assets/items-img/paneled-door.png')} />
            ...
            <View style={{ marginTop: 15 }}>
                <View style={ItemStyles.flex}>
                    <Text style={ItemStyles.title}>Flat Door</Text>
                </View>
            ...
            <View style={{ marginTop: 15 }}>
                <View style={ItemStyles.flex}>
                    <Text style={ItemStyles.title}>Paneled Door</Text>
                </View>
                <View style={[ItemStyles.setPadding, { marginTop: 2 }]}>
                    <View style={ItemStyles.inputLabel}>
                        <Text style={ItemStyles.labelColor}>Price:</Text>
            ...
            <View style={{ marginTop: 15 }}>
                <View style={ItemStyles.flex}>
                    <Text style={ItemStyles.title}>French Door</Text>
                </View>
                <View style={[ItemStyles.setPadding, { marginTop: 2 }]}>
                    <View style={ItemStyles.inputLabel}>
                        <Text style={ItemStyles.labelColor}>Price:</Text>
            ...
            <View style={{ marginTop: 15 }}>
                <View style={ItemStyles.flex}>
                    <Text style={ItemStyles.title}>Bi-Fold-Door</Text>
