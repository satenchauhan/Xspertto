...
const Ceilings = (props) => {
    ...
    return (
        <View>
            ...
            <View style={{ marginTop: 10 }}>
                <View style={ItemStyles.lwhSection}>
                    <View>
                        ...
                        <View style={CStyles.inptFlex}>
                            <TextInput
                                style={CStyles.L_W_H_Input}
                                name={'length'}
                                placeholder={'0'}
                    ...
                    <View>
                        <Text style={ItemStyles.inputLabel}>Total Area:</Text>
                        <View style={CStyles.inptFlex}>
                            <TextInput
            ...
            {/* Flat and Texture */}
            <View>
                <Text style={ItemStyles.optionTitle}>Ceiling Surface Type</Text>
