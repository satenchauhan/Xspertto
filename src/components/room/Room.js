...
import {View,TextInput, ScrollView,TouchableOpacity,Animated,TouchableHighlight, LayoutAnimation, Dimensions, UIManager, SafeAreaView} from 'react-native';
import MaterialIcons from 'react-native-vector-icons/MaterialIcons';
import MaterialCommunityIcons from 'react-native-vector-icons/MaterialCommunityIcons'
import FontAwesome from 'react-native-vector-icons/FontAwesome';
import { RoomStyles } from './RoomStyles';
import AddImageSection from '../addImage/AddImageSection';
import AddNoteSection from '../addNote/AddNoteSection';
...
const Room = (props) => {
    ...
    return (
        <SafeAreaView style={{flex:1}}>
            <View style={{height: roomHeight, position:'relative', bottom:10}}>
                <ScrollView
                    stickyHeaderIndices={[0]} 
                    onScroll={()=>onSwipeTop()}
                    style={[RoomStyles.scrollContainer]} 
                >   
                    <View style={[RoomStyles.roomHeader,{height: showHeight===false ? 'auto' :fixHeight}]}>
                    ...
                    <Animated.View style={[RoomStyles.CustomPopUp,{position:'absolute', top: showHeight===false ? 1 : 1, right:2 },{...props.style, height:MenuAnim1, width:MenuAnim2}]}>
            ...
            {showFooter === true ? 
                <View style={[RoomStyles.footerSection]}>
